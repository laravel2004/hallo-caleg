  ...
  <div class="h-full overflow-y-auto bg-gray-50 px-3 py-4">
      ...
      <div class="flex flex-col justify-between">
          <ul class="space-y-2 font-medium">
              ...
              <li>
                  <a href="{{ route('dashboard.quickcount.index') }}" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100">
                      <i class='bx bx-user-circle text-3xl text-[#6b7280]'></i>
                      <span class="ms-3 flex-1 whitespace-nowrap">Quickcount</span>
                  </a>
              </li>
          </ul>
